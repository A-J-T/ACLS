...
public class pattern7 {
    ...
    public static void singlePathASCII(String message)
    {
        ...
        String binaryString=LOPS.EXOR(bString, Integer.toString(111111111));
    ...
    public static void decrypt()
    {
        ...
        System.out.println("isFileSelected: "+DecodeMain.isFileSelected());
        if(DecodeMain.isFileSelected()==1)
        {
    ...
    public static void decodeFile()
    {
        ...
        for(int i=0;i<nOF;i++)
        {
            ...
            binaryString=LOPS.EXOR(binaryString,"111111111");
