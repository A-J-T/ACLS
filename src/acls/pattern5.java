...
public class pattern5 {
    ...
    public static void singlePathASCII(String message)
    {
        ...
        String binaryString=LOPS.NAND(bString, Integer.toString(111111111));
    ...
    public static void decodeFile()
    {
        ...
        for(int i=0;i<nOF;i++)
        {
            ...
            binaryString=LOPS.NAND(binaryString,"111111111");
